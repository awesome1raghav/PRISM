          ...
          <section>
            <div className="text-center mb-8">
              ...
              <p className="text-muted-foreground">
                Live conditions for: <span className="font-semibold text-foreground">Koramangala, Bengaluru</span>
              </p>
            </div>
            ...
            <div className="grid md:grid-cols-3 gap-6 max-w-5xl mx-auto text-center">
              <Card className="bg-card/40 border-border/30 border-l-4 border-l-green-500">
                <CardHeader>
                  <CardTitle className="flex items-center justify-center gap-2"><Wind className="text-green-500" />Air Quality</CardTitle>
               ...
               <Card className="bg-card/40 border-border/30 border-l-4 border-l-green-500">
                <CardHeader>
                  <CardTitle className="flex items-center justify-center gap-2"><Droplets className="text-green-500" />Water Quality</CardTitle>
               ...
               <Card className="bg-card/40 border-border/30 border-l-4 border-l-yellow-500">
                <CardHeader>
                  <CardTitle className="flex items-center justify-center gap-2"><Waves className="text-yellow-500" />Noise Level</CardTitle>
             ...
             <div className="grid gap-4 md:grid-cols-2 max-w-4xl mx-auto">
                <Card className="bg-card/40 border-border/30">
                    <CardContent className="p-6 flex items-center gap-4">
                        ...
                        <div>
                            <h3 className="font-semibold">Moderate PM2.5 Levels</h3>
