...
const FeatureCard = ({ feature }: { feature: typeof companyFeatures[0]}) => (
     <Link href={feature.href} key={feature.title} className="group block">
        <Card className="h-full flex flex-col transition-all duration-300 hover:-translate-y-1 hover:shadow-lg hover:shadow-primary/10 hover:border-primary/30">
            <CardHeader>
      ...
      <main className="flex-grow container py-12">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            <Link href="/company/investigations" className="group block lg:col-span-1">
                <Card className={cn(
                    "border-l-4 h-full transition-all duration-300 hover:-translate-y-1 hover:shadow-lg",
