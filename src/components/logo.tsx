  ...
  return (
    <div className={cn('h-8 w-8 relative flex items-center justify-center', className)}>
      ...
      >
        ...
        {/* Outer Gold Ring */}
        <circle cx="50" cy="50" r="45" fill="none" stroke="url(#grad-gold)" strokeWidth="4"/>
        <circle cx="50" cy="50" r="38" fill="none" stroke="#2c3e50" strokeWidth="8"/>
        ...
        <g transform="translate(50, 50) rotate(30)">
            ...
            {/* Facets */}
            <path d="M0 -32 L-27.7 -16 L0 -16 Z" fill="url(#grad-blue)" />
            <path d="M0 -32 L27.7 -16 L0 -16 Z" fill="#6CB9E1" />
            <path d="M-27.7 -16 L-27.7 16 L0 16 L0 -16 Z" fill="url(#grad-green)"/>
            <path d="M-27.7 16 L0 32 L0 16 Z" fill="#76C779" />
            <path d="M27.7 -16 L27.7 16 L0 16 L0 -16 Z" fill="url(#grad-red)" />
            <path d="M27.7 16 L0 32 L0 16 Z" fill="#F7A188" />
        </g>
