    ...
    <section className="relative w-full flex items-center justify-center pt-32 pb-40 overflow-hidden">
      ...
      <div className="relative z-10 flex h-full flex-col items-center justify-center text-center text-foreground">
        <div className="container max-w-5xl">
          <h1 className="text-6xl font-bold tracking-tight sm:text-7xl md:text-8xl text-foreground drop-shadow-lg">
            PRISM
          </h1>
          ...
          <div className="mt-12 flex flex-wrap justify-center gap-4">
            ...
            <Button asChild size="lg" variant="outline" className="text-foreground border-border hover:bg-accent hover:text-accent-foreground transition-all duration-300 hover:-translate-y-0.5">
